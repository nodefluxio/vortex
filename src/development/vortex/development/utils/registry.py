...
class Registry:
    ...
    def register(self, module=None, name: Union[str,None]=None, force: bool=False, overwrite: bool=False):
        # typecheck
        ...
        if module is None:
            def _register(mod):
                self.register(module=mod,name=name,force=force,overwrite=overwrite)
                return mod
            return _register
        else:
            # typecheck
