...
predict_test_data() {
    python3.6 vortex/predict.py --config $CONFIG_FILE --image $TEST_IMAGE -o $OUTPUT_DIR
}

predict_test_data_batch() {
    python3.6 vortex/predict.py --config $CONFIG_FILE --image $TEST_IMAGE $TEST_IMAGE -o $OUTPUT_DIR
}

predict_test_data_custom_weights() {
    python3.6 vortex/predict.py --config $CONFIG_FILE --image $TEST_IMAGE --weights $PTH_FILE -o $OUTPUT_DIR
}
